...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_name, password, realname, user_role, department_id, cardno, tel_long, tel_short, tel_office, email, note, lock', 'required'),
			array('department_id, tel_short, lock', 'numerical', 'integerOnly'=>true),
