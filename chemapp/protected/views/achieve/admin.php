...
<?php	$action=($status==1)? 'view':'update';	//TJ:通过要查看的备案单的状态设置接下来查看备案单详情时调用的行为（view包含备案成功的信息）
	...
	'columns'=>array(
		...
		array(
			...
			'urlExpression'=>'Yii::app()->controller->createUrl("'.$action.'", array("id"=>$data->primaryKey,))'//显示URL
		),
